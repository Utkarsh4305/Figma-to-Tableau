...
const SECTIONS = [
  { id: "getting-started", label: "Getting started", color: "#f4512c" },
  { id: "prefixes", label: "Layer prefixes", color: "#8a4dff" },
  { id: "chart-types", label: "Chart types", color: "#18a0fb" },
  { id: "options", label: "Sheet options", color: "#0aa268" },
  { id: "navigation", label: "Navigation", color: "#dd7714" },
  { id: "swap", label: "Worksheet swap", color: "#f4512c" },
  { id: "export-modes", label: "Export modes", color: "#8a4dff" },
  { id: "templates", label: "Templates", color: "#18a0fb" },
  { id: "plans", label: "Plans & limits", color: "#0aa268" },
  { id: "troubleshooting", label: "Troubleshooting", color: "#dd7714" },
];
